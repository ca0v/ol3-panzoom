...
define("examples/black", ["require", "exports", "openlayers", "index"], function (require, exports, ol, index_2) {
    "use strict";
    exports.__esModule = true;
    function run() {
...
define("examples/black-slider", ["require", "exports", "openlayers", "index"], function (require, exports, ol, index_3) {
    "use strict";
    exports.__esModule = true;
    function run() {
        var minZoom = 6;
        var maxZoom = 15;
        var panZoom = new index_3.PanZoom({
            imgPath: "../ol3-panzoom/resources/zoombar_black",
            minZoom: minZoom,
            maxZoom: maxZoom,
            slider: true
...
define("examples/maxextent", ["require", "exports", "openlayers", "index", "node_modules/ol3-fun/ol3-fun/common"], function (require, exports, ol, index_4, common_3) {
    "use strict";
    exports.__esModule = true;
    function run() {
        ...
        function markit(position, text) {
            if (text === void 0) { text = "X"; }
            map.addOverlay(new ol.Overlay({
                position: position,
                element: common_3.html("<div className=\"X\">" + text + "</div>")
            }));
        }
    }
    exports.run = run;
});
define("examples/simple", ["require", "exports", "openlayers", "index"], function (require, exports, ol, index_5) {
    "use strict";
    exports.__esModule = true;
    function run() {
        var panZoom = new index_5.PanZoom();
        var map = new ol.Map({
            controls: ol.control
                .defaults({
                zoom: false
...
define("examples/slider", ["require", "exports", "openlayers", "index"], function (require, exports, ol, index_6) {
    "use strict";
    exports.__esModule = true;
    function run() {
        var panZoom = new index_6.PanZoom({
            slider: true
        });
        var map = new ol.Map({
            controls: ol.control
